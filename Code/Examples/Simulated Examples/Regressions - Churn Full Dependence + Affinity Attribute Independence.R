...
# Churn Data
source(here::here("Code/Examples/Simulated Examples", "Simulate Data - Churn Full Dependence + Affinity Attribute Independence.R"))
synthesized_data <- read_csv(here::here("Data/Simulated", "churnFULL_aaIND_synthesized.csv"))
...
# Final Results
final_results_churnFULL_aaIND <- bind_rows(
  accuracy_partial |>
  ...
  mutate(data = "churn full dependence, aa independence")


# drm(list = setdiff(ls(), c("final_results_partial", "final_results_full", "final_results_ind")))
