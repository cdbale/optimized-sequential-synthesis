...
points = read.csv("../Data/pre-aggregate.csv")
...
# age group labels
alabs = unique(iso_points$age)

# number of age groups
Ng = length(alabs)

# iso labels
isolabs = unique(iso_points$ISO)
