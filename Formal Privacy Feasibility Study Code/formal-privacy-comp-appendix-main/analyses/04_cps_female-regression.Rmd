...
## made edit here: moved the code below into its own chunk. We synthesize data for male/female at the same time.

## save the subset of IPUMS data

dir.create(file.path("../../..", "Data/IPUMS"), recursive=TRUE)

write.csv(asec_subset, "../../../Data/IPUMS/ipums_data.csv", row.names=FALSE)
```
